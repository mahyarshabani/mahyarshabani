...
# again set the director app as the working directory of BUILDER
WORKDIR /app
# copy all the content of the source code to WD
COPY . . 
# copy the node_modules created in deps to WD
